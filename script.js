...
### ⚠️ بس في نقطة مهمة جدًا

الطريقة دي **هتبعت الطلبات زي الفورم القديم إلى Web3Forms**، مش إلى Google Sheets.

ولو هدفك إن الـ HR يفتح **Google Sheet ويلاقي كل المتقدمين في جدول**، فده محتاج نضيف خطوة تانية للربط بـ **Google Apps Script**. ساعتها نقدر نخلي كل تقديم يتحط في صف، وأسئلة الـ Research مثلًا تبقى في أعمدة، وأسئلة الـ Marketing في أعمدة تانية.

وكمان أنا أنصح نعملها بحيث **الأسئلة الخاصة بالقسم اللي اختاره بس** هي اللي تتسجل، بدل ما الشيت يبقى مليان أعمدة فاضية.
